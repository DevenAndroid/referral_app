...
class UserRecommendationSingleScreen extends StatefulWidget {
  const UserRecommendationSingleScreen({super.key});

  @override
  State<UserRecommendationSingleScreen> createState() => _UserRecommendationSingleScreenState();
}

class _UserRecommendationSingleScreenState extends State<UserRecommendationSingleScreen> {

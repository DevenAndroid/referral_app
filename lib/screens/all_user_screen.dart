...
import 'package:referral_app/screens/search_screen.dart';
...
class AllUserProfileScreenState extends State<AllUserProfileScreen>
  ...
  void initState() {
    ...
    // profileController.idUserPro = profileController.idUserPro;
    profileController.UserProfile();
    reviewList(profileController.idUserPro);
    // chooseCategories1();
  }
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          Get.toNamed(
                                              MyRouters.singlePostScreen,
                                              arguments: [
                                                profileController.userProfile
                                                    .value.data!.user!.postCount
                                                    .toString()
                                              ]);
                                        },
                                        child: Column(
                                  ...
                                  children: [
                                    TabBar(
                                      ...
                                      tabs: [
                                        ...
                                        Tab(
                                          child: Text(
                                              "${profileController.userProfile.value.data!.user!.name!.capitalizeFirst.toString()} Recommendations",
                                              style: GoogleFonts.mulish(
                                                fontWeight: FontWeight.w400,
                                                fontSize: 14,
                                              )
                                        ...
                                        children: [
                                          Obx(() {
                                            return profileController
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        children: [
                                                                          GestureDetector(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: CachedNetworkImage(
                                                                                ...
                                                                                height: 30,
                                                                                fit: BoxFit.cover,
                                                                                imageUrl: profileController.userProfile.value.data!.myRequest![index].userId == null ? AppAssets.man : profileController.userProfile.value.data!.myRequest![index].userId!.profileImage.toString(),
                                                                          ...
                                                                          Column(
                                                                            crossAxisAlignment:
                                                                                CrossAxisAlignment.start,
                                                                            children: [
                                                                              profileController.userProfile.value.data!.myRequest![index].userId?.name == ""
                                                                                  ? Text(
                                                                                      "Name...",
                                                                                      style: GoogleFonts.mulish(
                                                                                          fontWeight: FontWeight.w700,
                                                                                  ...
                                                                                  : Text(
                                                                                      profileController.userProfile.value.data!.myRequest![index].userId!.name.toString().capitalizeFirst.toString(),
                                                                                      style: GoogleFonts.mulish(
                                                                                          fontWeight: FontWeight.w700,
                                                                                          // letterSpacing: 1,
                                                                                          fontSize: 14,
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              return GestureDetector(
                                                                                ...
                                                                                child: profileController.userProfile.value.data!.myRequest![index].wishlist == true
                                                                                    ? SvgPicture.asset(
                                                                                        AppAssets.bookmark1,
                                                                                        height: 20,
                                                                                      )
                                                                          ...
                                                                          GestureDetector(
                                                                              onTap: () {
                                                                                Share.share(
                                                                                  profileController.userProfile.value.data!.myRequest![index].image.toString(),
                                                                                );
                                                                              },
                                                                      ...
                                                                      profileController.userProfile.value.data!.myRequest![index].image ==
                                                                              ""
                                                                          ? const SizedBox()
                                                                          : ClipRRect(
                                                                              ...
                                                                              child: CachedNetworkImage(
                                                                                ...
                                                                                height: 200,
                                                                                fit: BoxFit.fill,
                                                                                imageUrl: profileController.userProfile.value.data!.myRequest![index].image.toString(),
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          Column(
                                                                            children: [
                                                                              profileController.userProfile.value.data!.myRequest![index].minPrice.toString().isNotEmpty ? const Text("Min Price") : const Text('No Budget'),
                                                                              profileController.userProfile.value.data!.myRequest![index].minPrice.toString().isNotEmpty
                                                                                  ? Text(
                                                                                      profileController.userProfile.value.data!.myRequest![index].minPrice.toString(),
                                                                                    )
                                                                                  : const SizedBox(),
                                                                            ],
                                                                          ),
                                                                          ...
                                                                          Column(
                                                                            children: [
                                                                              profileController.userProfile.value.data!.myRequest![index].maxPrice.toString().isNotEmpty ? const Text("Max Price") : const SizedBox(),
                                                                              profileController.userProfile.value.data!.myRequest![index].maxPrice.toString().isNotEmpty
                                                                                  ? Text(
                                                                                      profileController.userProfile.value.data!.myRequest![index].maxPrice.toString(),
                                                                                    )
                                                                                  : const SizedBox(),
                                                                            ],
                                                                          ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              onTap: () {
                                                                                setState(() {
                                                                                  ...
                                                                                  print('Id Is....${profileController.userProfile.value.data!.myRequest![index].id.toString()}');
                                                                                });
                                                                              },
                                                                              child: Container(
                                                                                ...
                                                                                child: Row(
                                                                                  children: [
                                                                                    ...
                                                                                    Text(
                                                                                      "Comments:   ${profileController.userProfile.value.data!.myRequest![index].commentCount.toString()}",
                                                                                      style: GoogleFonts.mulish(
                                                                                          fontWeight: FontWeight.w500,
                                                                                          // letterSpacing: 1,
                                                                                          fontSize: 12,
                                                ...
                                                : profileController.statusOfUser
                                                        .value.isError
                                                    ? CommonErrorWidget(
                                                        errorText: "",
                                                        onTap: () {},
                                                                  ...
                                                                  children: [
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: Image
                                                                            .asset(
                                                                          'assets/images/categoryList.png',
                                                                          width:
                                                                              35,
                                                                        ),
                                                                      ),
                                                                        ...
                                                                        ClipOval(
                                                                          child:
                                                                            ...
                                                                            fit:
                                                                                BoxFit.fill,
                                                                            imageUrl:
                                                                                profileController.single.value.data!.categoryImage.toString(),
                                          ...
                                          Column(
                                            children: [
                                              if (profileController
                                                      .checkForUser ==
                                                  true)
                                                profileController.statusOfSingle
                                                        .value.isSuccess
                                                    ? Column(
                                                        children: [
                                                          if (profileController
                                                          ...
                                                          itemBuilder:
                                                            ...
                                                            return GestureDetector(
                                                              onTap: () {
                                                                Get.toNamed(
                                                                  MyRouters
                                                                      .userRecommendationSingleScreen,
                                                                  arguments: [

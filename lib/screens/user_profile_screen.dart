                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(userProfile.value.data!.user!.phone.toString(),
                                          style: GoogleFonts.mulish(
                                        ...
                                        return statusOfUser.value.isSuccess
                                            ? Column(
                                                children: [
                                                  ListView.builder(
                                                      shrinkWrap: true,
                                                      itemCount: userProfile.value.data!.saveRecommandation!.length,
                                                      physics: const NeverScrollableScrollPhysics(),
                                                      itemBuilder: (context, index) {
                                                        return Column(
                                                          children: [
                                                                ...
                                                                children: [
                                                                    ...
                                                                    children: [
                                                                      ClipOval(
                                                                        child: CachedNetworkImage(
                                                                          ...
                                                                          fit: BoxFit.cover,
                                                                          imageUrl: userProfile
                                                                              .value.data!.saveRecommandation![index].post
                                                                              .toString(),
                                                                          placeholder: (context, url) =>
                                                                              Image.asset(AppAssets.girl),
                                                                          errorWidget: (context, url, error) =>
                                                                  ...
                                                                  Stack(children: [
                                                                    CachedNetworkImage(
                                                                      ...
                                                                      fit: BoxFit.fill,
                                                                      imageUrl: userProfile
                                                                          .value.data!.saveRecommandation![index].post!.image
                                                                          .toString(),
                                                                      placeholder: (context, url) =>
                                                                          Image.asset(AppAssets.picture),
                                                                      errorWidget: (context, url, error) =>
                                                                  ...
                                                                  Text(
                                                                    userProfile
                                                                        .value.data!.saveRecommandation![index].post!.title
                                                                        .toString(),
                                                                    style: GoogleFonts.mulish(
                                                                        fontWeight: FontWeight.w700,
                                                                        // letterSpacing: 1,
                                                                  ...
                                                                  GestureDetector(
                                                                    ...
                                                                    child: Text(
                                                                      userProfile
                                                                          .value.data!.saveRecommandation![index].post!.link
                                                                          .toString(),
                                                                      style: GoogleFonts.mulish(
                                                                          fontWeight: FontWeight.w300,

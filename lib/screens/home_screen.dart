...
*/
  ...
  Rx<RxStatus> statusOfSingle = RxStatus
      .empty()
      .obs;
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  GestureDetector(
                                                    onTap: () {
                                                      setState(() {
                                                        getReviewListRepo(context: context, id: homeController.homeModel.value.data!.discover![index]
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          Text(
                                                            "Recommendation: ${homeController.homeModel.value.data!.discover![index]

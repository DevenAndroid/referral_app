...
Future<AskRecommendationModel> askRecommendationRepo({
  required mapData,
  required fieldName1,
  required File file1,
  required context,
  ...
  try {
    var request =
        http.MultipartRequest('POST', Uri.parse(ApiUrls.addAskRecommandation));
    ...
    if (response.statusCode == 200) {
      ...
      return AskRecommendationModel.fromJson(
    ...
    Helpers.hideLoader(loader);
    return AskRecommendationModel(message: "No Internet Access", status: false);
  } catch (e) {
    Helpers.hideLoader(loader);
    return AskRecommendationModel(message: e.toString(), status: false);
  }
}
...
Future<AskRecommendationModel> updateAskRecommendationRepo({
  required mapData,
  required fieldName1,
  required File file1,
  required id,
